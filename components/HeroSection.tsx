...
export default function HeroSection() {
  ...
  return (
    <section className="w-full py-12 md:py-24 relative z-20 sm:w-90">
          ...
          <div className="relative flex flex-col items-center space-y-2 text-center  bg-transparent">
            <div className="relative bg-opacity-70 bg-blur-lg bg-cover bg-center rounded-lg p-8 z-0">
              <div className="space-y-10">
                <h1 className=" font-extrabold tracking-tighter  text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text z-50  md:text-9xl lg:text-9xl text-6xl">
                  Spark-2k24
                </h1>
                ...
                <p className="max-w-[600px] text-2xl text-gray-200 md:text-xl/none md:mx-auto lg:text-base xl:text-xl dark:text-green-200 z-50">
                  A Technical symposium organized by the CSE department of ADCET
                  under the CESA.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-10 justify-center mt-6 sm:text-sm ">
              ...
              >
                ...
                >
                  <Image
                    className="m-auto"
                    src="https://raw.githubusercontent.com/atharvsankpal7/Spark/master/public/Images/Spark2k24.png"
                    alt="spark2k24"
                    width={1000}
                    height={500}
                  />
